...
export const createTaskFailure = createAction('[Task API] Create Task Failure', props<{ error: string }>());
...
export const updateTaskFailure=createAction('[Task API] Update Task Failure',props<{error:string}>());
...
export const deleteTaskFailure=createAction('[Task API] Delete Task Failure',props<{error:string}>());
